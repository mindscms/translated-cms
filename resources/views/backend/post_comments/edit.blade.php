...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">{{ __('Backend/post_comments.edit_comment_on') }} ({{ $comment->post->title }})</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="form-group">
                        {!! Form::label('name', __('Backend/post_comments.name')) !!} {{ $comment->user_id != '' ? '(Member)' : '' }}
                ...
                <div class="col-4">
                    <div class="form-group">
                        {!! Form::label('url', __('Backend/post_comments.url')) !!}
            ...
            <div class="row">
                <div class="col-6">
                    {!! Form::label('ip_address', __('Backend/post_comments.ip_address')) !!}
