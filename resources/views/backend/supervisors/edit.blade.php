    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('status', ['' => '---', '1' =>  __('Backend/supervisors.active'), '0' =>  __('Backend/supervisors.inactive')],old('status', $user->status), ['class' => 'form-control']) !!}
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('receive_email', ['' => '---', '1' =>  __('Backend/supervisors.yes'), '0' =>  __('Backend/supervisors.no')],old('receive_email', $user->receive_email), ['class' => 'form-control']) !!}
                ...
                @if ($user->user_image != '')
                    <div class="col-12 text-center">
                        <div id="imgArea">
                            ...
                            <button class="btn btn-danger removeImage">{{  __('Backend/supervisors.remove_image') }}</button>
                        </div>
                    </div>
                @endif
                <div class="col-12">
            ...
            <div class="form-group pt-4">
                {!! Form::submit( __('Backend/supervisors.update'), ['class' => 'btn btn-primary']) !!}
            </div>
            {!! Form::close() !!}
        </div>
    </div>
