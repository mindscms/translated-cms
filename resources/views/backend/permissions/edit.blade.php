                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <select name="sidebar_link" class="form-control">
                            <option value="1" {{ old('sidebar_link', $permission->sidebar_link) == '1' ? 'selected' : '' }}>{{ __('Backend/permissions.yes') }}</option>
                            <option value="0" {{ old('sidebar_link', $permission->sidebar_link) == '0' ? 'selected' : '' }}>{{ __('Backend/permissions.no') }}</option>
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <select name="appear" class="form-control">
                            <option value="0" {{ old('appear', $permission->appear) == '0' ? 'selected' : '' }}>{{ __('Backend/permissions.no') }}</option>
                            <option value="1" {{ old('appear', $permission->appear) == '1' ? 'selected' : '' }}>{{ __('Backend/permissions.yes') }}</option>
                        </select>
